import Proxy from "./ProxyLegacy"; // Adjust the import path as needed
import * as cheerio from "cheerio";
import { Element } from "domhandler";
import cleanText from "./cleanText"; // Adjust the import path as needed
import cleanImageUrl from "./cleanImageUrl"; // Adjust the import path as needed
